/*ruler.tsx для... повзунка зверху з числами*/
        ...
        if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
            ...
            if (container) {
                ...
                if (isDraggingLeft) {
                    ...
                    const minRightPosition = leftMargin + MINIMUM_SPACE;
                    const newRightPosition = Math.max(rawPosition, minRightPosition);
                    setRightMargin(PAGE_WIDTH - newRightPosition);
                }
            }
        }
    };
...
const Marker = ({
  ...
  return (
    ...
    >
      ...
      {/* Вертикальна лінія при перетягуванні */}
      <div
        className={`absolute left-1/2 top-4 w-[1px] bg-blue-500 transition-all duration-200 ${
          isDragging ? "opacity-100 scale-x-50" : "opacity-0 scale-x-0"
        }`}
        style={{ height: "100vh" }}
      />
    </div>
